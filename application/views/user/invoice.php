                ...
                <div class="row">
                    ...
                    <div class="col-xs-10">
                        ...
                        <div class="panel panel-body">
                            ...
                            <br />
                            <div class="row">
                                <img src="<?php echo base_url("assets\userpanel\images/sign.png")?>" style="position: relative; left: 730px; top: -50px; " />
                                <div class="col-md-3 pull-right" style="border: none; border-bottom:2px solid #dedede;"></div>
                                <div class="col-md-2 pull-right" style="margin-right: -40px; margin-top: -15px;">Approved By:</div>
                            </div>
